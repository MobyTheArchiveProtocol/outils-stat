  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="panel p-6 sm:p-8">
        <div className="flex max-w-2xl flex-col gap-5 text-[var(--text-soft)]">
          <p className="text-lg leading-relaxed text-[var(--text)]">
            outils-stat existe pour retrouver la simplicité des anciens sites de tracking de stats
            de jeu : une interface épurée, de la data claire, et rien d’autre.
          </p>
          <p className="leading-relaxed">
            Aucune publicité. Aucun tracker tiers. Aucune collecte de données personnelles pour la
            revente ou l’analyse. Le <code className="text-[var(--gold-bright)]">referrer</code> est
            désactivé, les robots d’indexation restent respectés, et les requêtes vers les APIs de
