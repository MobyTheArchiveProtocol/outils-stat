...
export default function AboutPage() {
  return (
    <div className="mx-auto w-full max-w-3xl flex-1 px-6 py-20">
      ...
      <h1 className="mt-2 text-3xl font-semibold uppercase tracking-tight text-[var(--foreground-frost)]">À propos</h1>
      <div className="mt-8 flex flex-col gap-6 text-[var(--muted)]">
        <p className="text-lg leading-relaxed text-[var(--foreground-frost)]">
        ...
        <p className="leading-relaxed">
          ...
          revente ou l’analyse. Le <code className="font-mono text-[var(--accent)]">referrer</code>{" "}
